...
raw_output_file = r"Partial_Scraped_data\Raw_tweets_1.csv"

# specify the path for output file
updated_file_path = r"Output_Part-1 (scraping tweets)\test.csv" # specify the save file name
...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# User-Editable Query and Date Range

# Modify the query below to customize your search parameters.
# You can adjust the keywords, medications, or add more search terms as needed.
# Additionally, specify the desired start and end times for the time range of the search.
# Ensure the date format is in UTC (YYYY-MM-DDTHH:MM:SSZ) for both start_time and end_time.
